...
public class GMailer {
    ...
    private static final String SENDER_EMAIL = "ahmed.mtimet@esprit.tn";
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory)
        ...
        GoogleClientSecrets clientSecrets = GoogleClientSecrets.load(jsonFactory,
                new InputStreamReader(GMailer.class.getResourceAsStream(
                        "/client_secret_173501250502-1h0v0bpohg93a5ntjacvm244ik9tr49s.apps.googleusercontent.com.json")));
    ...
    // Updated sendMail method to support attachments
    public void sendMail(String recipientEmail, String subject, String messageText, File pdfAttachment) throws Exception {
        ...
        // Part 2: The PDF attachment (if provided)
        ...
        // Encode the email as a Gmail message
