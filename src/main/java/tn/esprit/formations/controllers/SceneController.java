...
import tn.esprit.formations.entities.Department;
...
public class SceneController {
    ...
    public static void openAdminViewScene() {
        try {
            FXMLLoader loader = new FXMLLoader(MainMenuController.class.getResource("/fxml/admin/AdminView.fxml"));
            Parent root = loader.load();
            mainPane.setCenter(root); // Assuming mainPane is a static reference to the BorderPane center
        } catch (IOException e) {
            System.err.println("Error loading AdminView.fxml: " + e.getMessage());
            e.printStackTrace();
        }
    }
